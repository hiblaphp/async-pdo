...
final class AsyncPDO
{
     ...
     *
     * @throws AsyncPDONotInitializedException If not currently in a transaction or if AsyncPDO is not initialized
     */
     ...
     *
     * @throws AsyncPDONotInitializedException If AsyncPDO has not been initialized
     *
    ...
    private static function getInstance(): AsyncPDOConnection
    {
        if (! self::$isInitialized || self::$instance === null) {
            throw new AsyncPDONotInitializedException();
        }
